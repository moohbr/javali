...
public class Factory {
  ...
  public static User createUser(@NotNull Types type)
  ...
  public static Command getCommand(@NotNull CommandsAvailable command)
      throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException,
      InstantiationException, IllegalAccessException {
    String commandPackage = command.toString().toLowerCase();
    Class<?> clazz = Class.forName("br.unifei.imc.bin.cli." + commandPackage + "."
        + command);
    Constructor<?> constructor = clazz.getConstructor();
